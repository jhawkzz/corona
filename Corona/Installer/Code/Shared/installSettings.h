...
#define IV_RUN_ONCE_MUTEX_STRING "Corona is already running."

// set the program name here.
#define IV_PROGRAM_NAME          "Corona"

// set the uninstaller registry key here
#define IV_UNINSTALL_REG_KEY     "Corona"

// set the default program folder name here
#define IV_DEFAULT_PROGRAM_FOLDER "Corona"

// Add/Remove Program values 
#define IV_PUBLISHER_NAME        "Jered McFerron"
#define IV_URL_INFO_ABOUT        "http://www.thenewadventuresofoldbenfranklin.com"
#define IV_URL_UPDATE_INFO       "http://www.thenewadventuresofoldbenfranklin.com"
#define IV_HELP_LINK             "http://www.thenewadventuresofoldbenfranklin.com"
#define IV_DISPLAY_VERSION       "1.00"
